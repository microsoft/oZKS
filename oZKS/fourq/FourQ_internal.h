...
#define ADD128(addend1, addend2, addition) \
    fourq_mp_add((digit_t *)(addend1), (digit_t *)(addend2), (digit_t *)(addition), NWORDS_FIELD);

// 128-bit addition with output carry
#define ADC128(addend1, addend2, carry, addition) \
    (carry) = fourq_mp_add(                       \
        (digit_t *)(addend1), (digit_t *)(addend2), (digit_t *)(addition), NWORDS_FIELD);
...
unsigned int fourq_mp_add(digit_t *a, digit_t *b, digit_t *c, unsigned int nwords);

// Schoolbook multiprecision multiply, c = a*b
void fourq_mp_mul(const digit_t *a, const digit_t *b, digit_t *c, const unsigned int nwords);
