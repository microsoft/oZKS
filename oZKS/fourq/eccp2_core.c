...
#include "oZKS/fourq/FourQ_params.h"
#include "oZKS/fourq/FourQ_tables.h"
#if defined(GENERIC_IMPLEMENTATION)
#include "oZKS/fourq/generic/fp.h"
#elif (TARGET == TARGET_AMD64)
#include "oZKS/fourq/amd64/fp_x64.h"
#elif (TARGET == TARGET_ARM64)
#include "oZKS/fourq/arm64/fp_arm64.h"
#endif
